<section class="section">
            ...
            <div id="navbarBasicExample" class="navbar-menu">
                <div class="navbar-start">
                    ...
                    <?php if (in_array("pegawai.submission", session()->get('permissions'))) { ?>
                        <a class="navbar-item" href="/submission_form">
                            Pengajuan Faktur
                        </a><?php } ?>
                    <?php if (in_array("hrd.manage-users", session()->get('permissions'))) { ?>
                        <a class="navbar-item" href="/user_management">
                            Manajemen Pengguna
                        </a><?php } ?>
                    <?php if (in_array("hrd.monitor", session()->get('permissions'))) { ?>
                        <a class="navbar-item" href="/submission_table">
                ...
                <div class="navbar-end">
                    ...
                    <div class="navbar-item">
                        <div class="buttons">
                            <a class="button is-light" id="logout-menu" href="#">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const $navbarDropdown = Array.prototype.slice.call(document.querySelectorAll('.dropdown'), 0);
